...
def _wiring_message(conftest_wired: str | None, collects: bool, passed: int) -> str:
    ...
    proof = (
        f"verified {passed} test(s) pass under pytest"
        if collects
        else "⚠ pytest could NOT collect the generated tests — check the import path"
    )
...
def wire_pytest(project_root: str, test_path: str) -> PytestWiring:
    ...
    return PytestWiring(conftest_wired, collects, passed, _wiring_message(conftest_wired, collects, passed))
...
def certify(
    ...
    *,
    ...
    return CertifyResult(
        func_key, scope, result.total_survived, at_ceiling, source, written, plan, wiring
    )
